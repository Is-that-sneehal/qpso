...
export const MissionControlDashboard: React.FC<MissionControlDashboardProps> = ({
  ...
  return (
    <div className="max-w-[1440px] mx-auto px-6 py-8 space-y-10 font-sans">
      ...
      <div className="w-full max-w-5xl mx-auto text-center space-y-6 py-6">
        <h1 className="font-display-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-[#f4f1e8] uppercase leading-snug tracking-wide">
